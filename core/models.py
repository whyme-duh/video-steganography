...
class Encoding(models.Model):
    video = models.FileField(upload_to='videos/', null = True, verbose_name="", validators=[FileExtensionValidator(allowed_extensions=["MP4", 'AVI'])])
...
class Decoding(models.Model):
    video = models.FileField(upload_to='decoded/', null = True, verbose_name="", validators=[FileExtensionValidator(allowed_extensions=["MP4", "AVI"])])
    secret_key = models.CharField(max_length = 80, null = True, blank = True)
